# Sentiment_API — Technical Document Package v1.0
...
- `SENTIMENT_API_MASTER_SPEC_v1.0.md` — single “source of truth” mega-doc.
...
1. Open `SENTIMENT_API_MASTER_SPEC_v1.0.md`.
...
- `SENTIMENT_API_SCOPE_TECH_SPEC_v1.0_PRD.md` — PRD-style scope + requirements
