...
- `universe_registry.yaml` — defines ticker universes (S&P 500, Nasdaq Composite) and refresh providers.
- `universe_registry.schema.json` — schema to validate universe registry.
