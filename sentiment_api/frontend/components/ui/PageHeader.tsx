...
export function PageHeader({
  ...
  return (
    <section className={cn("glass-strong p-5 md:p-6 relative overflow-hidden", className)}>
      ...
      <div className="relative">
        <div className="flex flex-wrap items-center gap-3 justify-between">
          <div>
            ...
            {subtitle && <div className="text-sm md:text-base opacity-70 mt-1">{subtitle}</div>}
